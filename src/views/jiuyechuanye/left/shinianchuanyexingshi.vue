...
const datas = years.map(() => Math.ceil(Math.random() * 14000 + 5000))
const datasLine = years.map(() => Math.ceil(Math.random() * 14000 + 5000))
...
const setOption = () => {
  setTimeout(() => {
    ...
    for (let i = 0;i < 10;i++){
      ...
      totalDataTwo.push(Math.ceil(Math.random() * 14000 + 5000))
    }
