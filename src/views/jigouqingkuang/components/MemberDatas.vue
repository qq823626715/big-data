    ...
    <div class="wrapper-center">
      ...
      <div class="center-row-two">
        <div class="member-data-item">
          <div class="data-left">
            <span class="data-item-title">中心机构数</span>
            <h2 class="data-item-number">
              <CountTo :startVal="0" :endVal="25" :durantion="2000"></CountTo>
            </h2>
          </div>
        </div>
        <div class="member-data-item">
          <div class="data-left">
            <span class="data-item-title">中心站工作人员数</span>
            <h2 class="data-item-number single">
              <CountTo :startVal="0" :endVal="195408" :durantion="5000"></CountTo>
            </h2>
          </div>
        </div>
      </div>
